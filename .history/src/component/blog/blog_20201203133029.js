...
class Blog extends React.Component {    
    ...
    JumpToBlogListPage(){
        this.props.history.push('/Home/BlogListPage')
    }
        ...
        return (
            <div className='blog'>
                    <div className="blogTitle">
                        ...
                        <Link to='/Home/BlogListPage' className="blogMore" onClick={() => {this.JumpToBlogListPage()}} value={this.state.type}>MORE {String('>')}</Link>
                    </div>
