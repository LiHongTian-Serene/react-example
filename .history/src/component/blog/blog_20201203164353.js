...
class Blog extends React.Component {    
    ...
    componentDidMount() {
        fetchData('./mock/BlogListPage/blogDetails.json').then((res) => {
            console.log(res);
            this.setState({
                blogName:res.author,
                date: res.date,
        ...
        return (
            <div className='blog'>
                    <div className="blogTitle">
                        ...
                        <Link to='/BlogListPage/' className="blogMore" value={this.state.type}>MORE {String('>')}</Link>
                    </div>
                    ...
                    <Router><Route path='/BlogListPage/' component={BlogListPage} /></Router>
